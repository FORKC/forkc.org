	...
	class TC_Form_Fields_API {
		...
		function add_common_fields() {
			...
			$fields[ 'gateway_show_priority' ] = array(
				'title'			 => __( 'Gateway Show Priority', 'tc' ),
				'type'			 => 'select',
				'options'		 => $gateway_priorities,
				'default'		 => '30',
				'description'	 => __( 'Select gateway show order on the front-end. Gateway with a value of 1 will be shown first. 30 is the default value.', 'tc' )
			);
